 ...
 */
public class BlockingServletEngineFactory  implements ServletEngineFactory {
  public ServletEngine createServletEngine(FilterChain dispatcher,
                                           ServletEngineConfiguration config)
      throws IOException, InterruptedException {
    return new BlockingServletEngine(dispatcher, config);
  }
}
