 ...
 */
public class ServletTestsWhichConnectToARemoteServer {
  /*
  ...
  */
  ...
  protected HttpRequestAsserter createGetAssertion(String uri) {
    HttpRequestAsserter asserter = createGetAssertion();
    asserter.setUri(uri);
    return asserter;
  }
}
