 ...
 *         Date: Jun 1, 2008
 */
public class HttpSessionAttributeListenerList
    implements HttpSessionAttributeListener {

  private final List<HttpSessionAttributeListener> listeners;

  public HttpSessionAttributeListenerList() {
    listeners = new ArrayList<HttpSessionAttributeListener>();
  }
  public void add(HttpSessionAttributeListener listener) {
